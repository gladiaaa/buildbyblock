...
// node_modules/nbt-js/nbt-js.js
var require_nbt_js = __commonJS({
  "node_modules/nbt-js/nbt-js.js"(exports) {
    var typeFields = ["name", "structure", "format", "size"];
    ...
    types.fromSchema = function(schema) {
      return typeof schema === "string" ? types[schema] : Array.isArray(schema) ? types.list : types.compound;
    };
...
export default require_nbt_js();
//# sourceMappingURL=nbt-js.js.map
